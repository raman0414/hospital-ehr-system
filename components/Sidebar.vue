  ...
  <aside :class="[
    ...
    <div class="h-full w-64 flex flex-col">
      <div class="h-full px-4 py-6 overflow-y-auto">
        ...
        <nav class="space-y-2">
          <NuxtLink to="/dashboard" class="flex items-center p-3 rounded-lg hover:bg-hospital-700 transition-colors group" active-class="bg-hospital-700">
          ...
          <NuxtLink to="/patients" class="flex items-center p-3 rounded-lg hover:bg-hospital-700 transition-colors group" active-class="bg-hospital-700">
            <svg class="w-5 h-5 text-gray-300 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <NuxtLink to="/vital-signs" class="flex items-center p-3 rounded-lg hover:bg-hospital-700 transition-colors group" active-class="bg-hospital-700">
            <svg class="w-5 h-5 text-gray-300 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
